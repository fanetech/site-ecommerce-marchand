 ...
 */
final class Version20220212163112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE marchand ADD description1 LONGTEXT DEFAULT NULL, ADD description2 LONGTEXT DEFAULT NULL, ADD description3 LONGTEXT DEFAULT NULL');
    }
