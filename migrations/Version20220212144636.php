 ...
 */
final class Version20220212144636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE description1 description1 LONGTEXT DEFAULT NULL, CHANGE description2 description2 LONGTEXT DEFAULT NULL, CHANGE description3 description3 LONGTEXT DEFAULT NULL, CHANGE picture1 picture1 VARCHAR(255) DEFAULT NULL, CHANGE picture2 picture2 VARCHAR(255) DEFAULT NULL, CHANGE picture3 picture3 VARCHAR(255) DEFAULT NULL');
    }
